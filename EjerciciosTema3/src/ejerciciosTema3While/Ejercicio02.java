...
public class Ejercicio02 {
	...
	public static void main(String[] args) {
		int suma = 0; 															// Establecemos la suma como 0 para que a la hora de empezar a sumar, 
		...
		while (num>=0) {														// Hacemos un while para establecer que siempre que añada un número
			...
			num=sc.nextInt();													// Si no quisieramos que llevase la cuenta, simplemente quitamos 
		}																		// el System.out.println(suma)
